    ...
    <div id="main">
        ...
        <div class="card card-body bg-light mt-5 mx-3">
            ...
            <form name="joinfrm" id="joinfrm">
                <div class="row">
                    <div class="row col-11 offset-1 mb-3">
                    ...
                    <div class="row col-11 offset-1 mb-3">
                        ...
                        <div class="col-3 ">
                            <input type="text"
                                   name="jumin1" id="jumin1" readonly
                                   class=" form-control border-danger bg-light" ></div>
                        <div class="col-3 ">
                            <input type="text"
                                   name="jumin2" id="jumin2" readonly
                                   class=" form-control border-danger bg-light" ></div>
                    </div>
                    ...
                    <div class="row col-11 offset-1 mb-3 align-items-center">
                        ...
                        <div class="col-auto ">
                            <span id="uidmsg" class="form-text">6~16 자의 영문 소문자, 숫자와 특수기호(_)만
                        사용할 수 있습니다.</span></div>
                    </div>
                    <div class="row col-11 offset-1 mb-3 align-items-center">
                        <label class="col-2 form-label text-danger text-end"
                        ...
                        <div class="col-3 ">
                            <input type="password"
                                   ...
                                   class=" form-control border-danger" ></div>
                        <div class="col-auto ">
                            <span id="pwdmsg" class="form-text">6~16 자의 영문 소문자, 숫자와 특수기호(_)만
                        사용할 수 있습니다.</span></div>
                    </div>
                    <div class="row col-11 offset-1 mb-3 align-items-center">
                        <label class="col-2 form-label text-danger text-end"
                        ...
                        <div class="col-3 ">
                            <input type="passwordd"
                                   ...
                                   class=" form-control border-danger" ></div>
                        <div class="col-auto ">
                            <span class="form-text">이전 항목에서 입력했던 비밀번호를 한번 더 입력하세요.</span></div>
                    </div>
